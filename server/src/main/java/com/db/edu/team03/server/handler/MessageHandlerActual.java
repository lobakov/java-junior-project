...
import com.db.edu.team03.server.Server;
...
public class MessageHandler implements Handler {
    ...
    MessageHandler(Server server, UserHandler userHandler, HistoryLogger historyLogger) {
        this.server = server;
    ...
    private String[] parse(String id, String message) {
